...
setup(
    name = 'janitoo_layouts',
    description = "The layouts (house, rooms, widgets, ..) for janitoo",
    long_description = "The layouts (house, rooms, widgets, ..) for janitoo",
    ...
    zip_safe = False,
    scripts=['src/scripts/jnt_layouts'],
